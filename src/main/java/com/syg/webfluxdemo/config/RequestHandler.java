...
public class RequestHandler {
    ...
    public Mono<ServerResponse> multiplyHandler(ServerRequest serverRequest) {
        Mono<MultiplayRequest> multiplayRequestMono = serverRequest.bodyToMono(MultiplayRequest.class);
        Mono<Response> responseMono = this.mathService.multiply(multiplayRequestMono);
        return ServerResponse.ok()
